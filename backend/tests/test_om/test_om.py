...
def test_R1_om(benchmark, dataset):
...
@pytest.mark.parametrize("dataset", data_list)
def test_R3_om(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_R2_om(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_R5_om(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_R4_om(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_R6_om(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
