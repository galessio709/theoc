...
# unary
epU1: EventPattern = EventPattern(et='pay order', phiet={}, op='=', n=1, q='order', ot='orders', phiot={})
fpU1: FlowPattern = FlowPattern(fp ='occurs', opD='>', td=0, psi=[])

# psi = 2 no constraint EP
epA3a: EventPattern = EventPattern(et="place order", phiet={}, op="=", n=1, q="customer", ot="customers", phiot={})
fpB3a: FlowPattern = FlowPattern(fp="precedes", opD=">", td=0, psi=["places", "comprises", "contains"])
epB3a: EventPattern = EventPattern(et="package delivered", phiet={}, op="=", n=1, q="shipped package", ot="packages", phiot={})

# psi = 2 yes constraint EP
epA3b: EventPattern = EventPattern(et="place order", phiet={'0': {'attr': 'timestamp', 'op': '<', 'val': '2023-10-01T20:29:00.000Z'}}, op="=", n=1, q="customer", ot="customers", phiot={})
fpB3b: FlowPattern = FlowPattern(fp="precedes", opD=">", td=0, psi=["places", "comprises", "contains"])
epB3b: EventPattern = EventPattern(et="package delivered", phiet={}, op="=", n=1, q="shipped package", ot="packages", phiot={})

# psi = 1 no constraint EP
epA2a: EventPattern = EventPattern(et='confirm order', phiet={}, op="=", n=1, q="customer", ot='customers', phiot={})
fpB2a: FlowPattern = FlowPattern(fp="corequisite", opD="<", td=216000, psi=["places"])
epB2a: EventPattern = EventPattern(et="payment reminder", phiet={}, op="=", n=1, q="order", ot="orders", phiot={})

# psi = 1 yes constraint EP
epA2b: EventPattern = EventPattern(et='confirm order', phiet={'0': {'attr': 'timestamp', 'op': '<', 'val': '2023-10-01T20:29:00.000Z'}}, op="=", n=1, q="customer", ot='customers', phiot={})
fpB2b: FlowPattern = FlowPattern(fp="corequisite", opD="<", td=216000, psi=["places"])
epB2b: EventPattern = EventPattern(et="payment reminder", phiet={}, op="=", n=1, q="order", ot="orders", phiot={})

# xLeadsTo psi = 1 no constraint EP
epA4: EventPattern = EventPattern(et='confirm order', phiet={}, op="=", n=1, q="customer", ot='customers', phiot={})
fpB4: FlowPattern = FlowPattern(fp="xLeadsTo", opD=">", td=0, psi=["places"])
epB4: EventPattern = EventPattern(et="payment reminder", phiet={}, op="=", n=1, q="order", ot="orders", phiot={})

'''
pytest tests/test_logic_OCCRb_om --benchmark-json tests/results/benchmark_results_om.json --benchmark-histogram tests/results/benchmark_plot_om
'''
...
def test_u_om(benchmark, dataset):
...
@pytest.mark.parametrize("dataset", data_list)
def test_b_om_2a(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_b_om_2b(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_b_om_3a(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_b_om_3b(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
...
@pytest.mark.parametrize("dataset", data_list)
def test_b_om_4(benchmark, dataset):
    """Test evalOCCRb for correctness and scalability."""
    setup_test_data(dataset)
