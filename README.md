...
<br><img src="./images/log.png" alt="Upload log" width="600"/>
...
1. Then the user can define the OCCR by specifying its elements through the user interface
   ...
   <br><img src="./images/ea.png" alt="Define Pa" width="600"/>
   ...
   <br><img src="./images/psi.png" alt="Define FP" width="600"/>

   - The second Event Pattern must be defined when a binary FP is chosen
   <br><img src="./images/eb.png" alt="Define Pb" width="600"/>
...
<br><img src="./images/results.png" alt="OCCR results" width="600"/>